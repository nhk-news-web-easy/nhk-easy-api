...
API of [nhk-easy-mobile](https://github.com/Frederick-S/nhk-easy-mobile), this repo relys on [nhk-easy-task](https://github.com/nhk-news-web-easy/nhk-easy-task) to fetch and parse news from [NEWS WEB EASY](https://www3.nhk.or.jp/news/easy/).
